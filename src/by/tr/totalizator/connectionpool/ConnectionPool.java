...
public final class ConnectionPool {
	...
	private void clearConnectionQueue() {
		try {
			...
			rootLogger.error("Error closing the connection.", e);			
		}
	}
	...
	public void closeConnection(Connection con, Statement st, ResultSet rs) {
		try {
			...
			rootLogger.error("Connection isn't return to the pool.");
		}
		try {
			rs.close();
		} catch (SQLException e) {
			rootLogger.error("ResultSet isn't closed.");
		}
		try {
			st.close();
		} catch (SQLException e) {
			rootLogger.error("Statement isn't closed.");
		}
	}
	...
	public void closeConnection(Connection con, PreparedStatement pst, ResultSet rs) {
		...
		try {
			...
			rootLogger.error("PreparedStatement isn't closed.");
		}
	}
